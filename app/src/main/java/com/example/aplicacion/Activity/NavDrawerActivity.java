...
public class NavDrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_estudiante) {
            Toast.makeText(getApplicationContext(), "Modulo Estudiante", Toast.LENGTH_SHORT).show();
            abrirAdmEstudiante();
    ...
    // Direcciona hacia el recycleView de Estudiante
    public void abrirAdmEstudiante() {
